...
namespace UdemyDockerizeAspNetCoreMvc.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            //appsettings içerisindeki envlerimi okuyabilmek için
        ...
        {
            //dosyalarımın isimlerini liste olarak alayım
        ...
        {
            //silenecek olan dosyayı bulayım
            var file = _fileProvider.GetDirectoryContents("wwwroot/images").ToList().First(x => x.Name
            == name);
